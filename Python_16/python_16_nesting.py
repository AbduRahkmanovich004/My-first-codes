...
#16-DARS nesting
#nesting bu lugat ichida toplam yoki toplam ichida lugat boladi

#ROYHAT ICHIDA LUGATLAR 
##################################################################################################################
...
car = car0                             #bu kod juda uzun hisoblanadi
...
cars = [car0, car1, car2]               #bu ixcham korinishdadi kod
for car in cars:
    print(f"{car['model'].title()}, "
          f"{car['rang']} rang, "
...
print(cars[1]["model"])     # print buyrugini bu holatda berishimiz mumkin
...
for ism, tillar in dasturchilar.items():
    ...
    for til in tillar:                                               #tillar list shaklida shakillanadi!
        print(til.upper())
